...
\begin{document}
    ...
    \newpage
    \input{Kapitel/Notation}

    \chapter{Einf\"uhrung}
        \input{Kapitel/00-Einfuehrung}

    \chapter{Topologische Mannigfaltigkeiten}
        \input{Kapitel/01-Topologische_Mannigfaltigkeiten}

    \chapter{Differenzierbare Mannigfaltigkeiten}
        \input{Kapitel/02-Differenzierbare_Mannigfaltigkeiten}
        
    \chapter{Teilung der Eins}
        \input{Kapitel/03-Teilung_der_Eins}
        
    \chapter{Der Immersionssatz}
        \input{Kapitel/04-Immersionssatz}
        
    \chapter{Der Einbettungssatz}
        \input{Kapitel/05-Einbettungssatz}

    %\chapter{Kobordismentheorie}
    %    \input{Kapitel/06-Kobordismentheorie}
